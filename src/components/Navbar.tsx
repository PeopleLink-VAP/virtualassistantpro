      ...
      <div className="container mx-auto px-4 py-3">
        ...
        <div className="flex justify-between items-center">
          <Link to="/" className="flex items-center gap-2 hover:scale-105 transition-transform">
            ...
            <span className="font-bold text-xl text-navy font-montserrat">Virtual Assistant PRO</span>
          </Link>
          ...
          <div className="hidden md:flex items-center space-x-4">
              ...
              <NavigationMenuList>
                <NavigationMenuItem>
                  ...
                  <NavigationMenuContent className="bg-white/90 backdrop-blur-sm p-4 rounded-lg min-w-[280px] navy-shadow">
                    <ul className="flex flex-wrap gap-2 text-xs">
                      <li>
                        <Link to="/about" className="block p-2 rounded hover:bg-sunflower/10 text-navy flex items-center gap-2 whitespace-nowrap">
                          <Home size={16} />
                          Giới Thiệu
                        </Link>
                      </li>
                      <li>
                        <Link to="/team" className="block p-2 rounded hover:bg-sunflower/10 text-navy flex items-center gap-2 whitespace-nowrap">
                          <Users size={16} />
                          Đội Ngũ Đào Tạo
                        </Link>
                      </li>
                ...
                <NavigationMenuItem>
                  ...
                  <NavigationMenuContent className="bg-white/90 backdrop-blur-sm p-4 rounded-lg min-w-[280px] navy-shadow">
                    <ul className="flex flex-wrap gap-2 text-xs">
                      <li>
                        <Link to="/courses-view" className="block p-2 rounded hover:bg-sunflower/10 text-navy flex items-center gap-2 whitespace-nowrap">
                          <BookOpen size={16} />
                          Xem Khóa Học
                        </Link>
                      </li>
                      <li>
                        <Link to="/training-program" className="block p-2 rounded hover:bg-sunflower/10 text-navy flex items-center gap-2 whitespace-nowrap">
                          <Globe size={16} />
                ...
                <NavigationMenuItem>
                  <Link to="/contact" className="flex items-center gap-1 text-navy hover:text-sunflower transition-colors px-4 py-2 font-montserrat">
                    <Mail size={18} />
                    Liên Hệ
                  </Link>
                </NavigationMenuItem>
                ...
                <NavigationMenuItem>
                  <Link to="/blog" className="flex items-center gap-1 text-navy hover:text-sunflower transition-colors px-4 py-2 font-montserrat">
                    <BookOpen size={18} />
                    Blog
                  </Link>
                </NavigationMenuItem>
            ...
            <Link to="/courses-view">
              <Button className="btn-primary backdrop-blur-sm hover:scale-105 transition-all font-montserrat">Xem Khóa Học</Button>
            </Link>
            
            <Link to="/login">
              <Button variant="outline" className="flex items-center gap-2 bg-transparent border border-navy text-navy hover:bg-navy hover:text-warmWhite transition-all backdrop-blur-sm hover:scale-105 font-montserrat">
